...
\begin{itemize}
    ...
    \item Vẽ biểu đồ \textbf{Tỷ lệ dương tính đúng (TPR / Recall)} so với \textbf{Tỷ lệ dương tính giả (FPR / Fall-out)}.
...
\begin{itemize}
    ...
    \item Giải pháp hiệu quả: \textbf{Tăng cường dữ liệu (Data Augmentation)}.
