...
\begin{frame}{Ước tính mật độ sinh ngẫu nhiên (Generative process)}
    \begin{itemize}
        \item GMM là một \textbf{Mô hình sinh ngẫu nhiên (Generative model)}.
...
\begin{frame}{Tóm tắt Chương 9: DBSCAN \& GMM}
    \begin{itemize}
        ...
        \item \textbf{GMM (Hỗn hợp Gaussian)} khắc phục nhược điểm về hình elip, rất mạnh trong \textbf{Phát hiện dị thường}.
