...
Dựa trên yêu cầu, hệ thống bài tập trắc nghiệm Chương 13 ("CHƯƠNG 13. TẢI VÀ TIỀN XỬ LÝ DỮ LIỆU VỚI") sẽ được xây dựng gồm tối thiểu 30 câu hỏi. Toàn bộ nội dung kiến thức để soạn câu hỏi sẽ được trích xuất **chính xác và trực tiếp** từ tài liệu Tiếng Việt của Chương 13 như sau:

## Nguồn tài liệu tham khảo chính
1. **Nội dung lý thuyết Tiếng Việt:** `docs/chuong_13.md` (Tab "Lý thuyết")

## Phạm vi kiến thức bao phủ (từ nguồn trên)
1. **API tf.data:** Các khái niệm, định nghĩa và đặc điểm liên quan.
2. **Sử dụng:** Các khái niệm, định nghĩa và đặc điểm liên quan.
3. **Định dạng TFRecord:** Các khái niệm, định nghĩa và đặc điểm liên quan.
4. **Các:** Các khái niệm, định nghĩa và đặc điểm liên quan.
5. **Các Lớp:** Các khái niệm, định nghĩa và đặc điểm liên quan.
6. **Dự án:** Các khái niệm, định nghĩa và đặc điểm liên quan.
7. **Bài tập:** Các khái niệm, định nghĩa và đặc điểm liên quan.

## Proposed Changes

Tôi sẽ tạo một trang HTML chứa tối thiểu 30 câu hỏi trắc nghiệm và nhúng nó vào file `docs/chuong_13.md`.
...
- Mở và cập nhật file `docs/chuong_13.md`.
- Tải lại trang web chính trên trình duyệt tại đường dẫn `/#/docs/chuong_13` và chuyển sang tab **Bài tập Trắc nghiệm**.
