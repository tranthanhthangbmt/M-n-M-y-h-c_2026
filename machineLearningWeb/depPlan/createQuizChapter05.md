...
Dựa trên yêu cầu, hệ thống bài tập trắc nghiệm Chương 5 ("CHƯƠNG 5. MÁY HỌC VÉC-TƠ HỖ TRỢ") sẽ được xây dựng gồm tối thiểu 30 câu hỏi. Toàn bộ nội dung kiến thức để soạn câu hỏi sẽ được trích xuất **chính xác và trực tiếp** từ tài liệu Tiếng Việt của Chương 5 như sau:

## Nguồn tài liệu tham khảo chính
1. **Nội dung lý thuyết Tiếng Việt:** `docs/chuong_05.md` (Tab "Lý thuyết")

## Phạm vi kiến thức bao phủ (từ nguồn trên)
1. **5.1. Phân loại SVM tuyến tính:** Các khái niệm, định nghĩa và đặc điểm liên quan.
2. **Phân loại SVM phi tuyến:** Các khái niệm, định nghĩa và đặc điểm liên quan.
3. **Các lớp SVM và độ phức tạp tính toán:** Các khái niệm, định nghĩa và đặc điểm liên quan.
4. **Hồi quy SVM:** Các khái niệm, định nghĩa và đặc điểm liên quan.
5. **Bên trong các bộ phân loại SVM tuyến tính:** Các khái niệm, định nghĩa và đặc điểm liên quan.
6. **SVM sử:** Các khái niệm, định nghĩa và đặc điểm liên quan.
7. **Bài tập:** Các khái niệm, định nghĩa và đặc điểm liên quan.

## Proposed Changes

Tôi sẽ tạo một trang HTML chứa tối thiểu 30 câu hỏi trắc nghiệm và nhúng nó vào file `docs/chuong_05.md`.
...
- Mở và cập nhật file `docs/chuong_05.md`.
- Tải lại trang web chính trên trình duyệt tại đường dẫn `/#/docs/chuong_05` và chuyển sang tab **Bài tập Trắc nghiệm**.
